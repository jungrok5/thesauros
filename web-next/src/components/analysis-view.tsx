  ...
  return (
    <div className="space-y-6">
      ...
      {/* 2026-05-26 F3: NoviceVerdict 제거. F1 commit 으로 BookVerdict
          가 analyzer의 eligibility 를 직접 받아 downgrade tone + 평이한
          headline (eligibility.headline) + body (eligibility.body) 를
          렌더. NoviceVerdict 의 위 카드 + BookVerdict 의 아래 카드가
          headline/body 가 똑같아져서 중복 → 1 카드로 통합. 자세한
          가이드 (보유 손절선 / 다음 결정 시점) + ⚠ 주의 는 BookVerdict
          가 계속 표시. */}
      <BookVerdict
        result={r}
