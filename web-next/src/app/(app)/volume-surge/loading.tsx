/**
 * /volume-surge loading — surge table placeholder.
 */
export default function Loading() {
  return (
    <div className="space-y-6 max-w-5xl animate-pulse" aria-label="거래량 폭증 로딩 중">
      <div className="space-y-2">
        <div className="h-8 w-48 rounded bg-muted" />
        <div className="h-4 w-96 rounded bg-muted/60" />
      </div>
      <div className="rounded-xl border-2 border-sky-500/40 bg-sky-500/5 p-4 space-y-2">
